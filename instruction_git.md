...
О команде git checkout, которая позволяет возвращаться на люубую из версий, будет написано ниже. Тем не менее, если мы вернулись на какую-то из наших предыдущих версий и хотим теперь увидеть и более позднее версии в журнале сохранений, то вводим в консоль следующую команду: 
